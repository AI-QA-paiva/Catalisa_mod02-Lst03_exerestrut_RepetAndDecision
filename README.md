# L3_mod2-exerestrut_RepetAndDecision
Averiguar conceitos de estruturas de repetição e decisão - Java basico - modulo 2 de aprendizado

A presente atividade está dividida em duas listas de exercícios, conforme titulos/foco 
a seguir:

Lista A com título "LISTA DE EXERCÍCIOS 003A - Entregar"
com foco em estruturas de Decisão (if, else, else if, switch)

lista B com tiutlo "LISTA DE EXERCÍCIOS 003B - Entregar"
com foco em estruturas de Repetição (for, for each, while, do ... while )

Atividades podem conter ainda aplicação de variáveis do tipo:
primitiva
Wrapper
arrays, array 2D, List, ArrayList, Set, Map

___________________________________________________________________________________

O conteúdo de cada atividade conforme abaixo:
